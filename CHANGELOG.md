...
### Octonica.ClickHouseClient v3.1.5, 2025-12-22

#### New Feature

* Add property `ClickHouseCommand.QueryId`. It allows to set a query identifier on the client side. Usually, a query identifier is
 generated by the server, setting it on the client side is not required.
...
* Improved error handling when opening a connection.
